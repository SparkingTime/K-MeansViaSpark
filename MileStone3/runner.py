...
os.system("spark-submit K-MeansMapCoord.DBpedia.py file:///home/training/K-MeansViaSpark/MileStone3/step3.Input/step3.filteredAll.csv 4 .1 Euclidean @1.GlobalClusters_Euclidian_k4")
