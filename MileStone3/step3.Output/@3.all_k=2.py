...
datapath = "@3.GlobalClusters_" + method+"_k2"
...
df_centers1 = pd.read_csv(
    "@3.GlobalClusters_Euclidian_k2/cluster_centers.csv")

df_centers2 = pd.read_csv(
    "@3.GlobalClusters_GreateCircle_k2/cluster_centers.csv")
...
layout = dict(
    ...
    title='All data Visulization k = 2 via '+ method,
...
layout_center = dict(
    ...
    title='All data Visulization k = 2 centers comparision Euclidian vs GreateCircle',
...
plotly.offline.plot(fig, filename='All_k=2'+method)
plotly.offline.plot(fig1, filename='All_k=2_Cluster_Centers')
