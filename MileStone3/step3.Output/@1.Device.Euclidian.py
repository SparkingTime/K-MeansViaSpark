...
df_cluster1 = pd.read_csv(
    './@1.DeviceLocationDataClusters_Euclidian/cluster_0.csv')
df_cluster2 = pd.read_csv(
    './@1.DeviceLocationDataClusters_Euclidian/cluster_1.csv')
df_cluster3 = pd.read_csv(
    './@1.DeviceLocationDataClusters_Euclidian/cluster_2.csv')
df_cluster4 = pd.read_csv(
    './@1.DeviceLocationDataClusters_Euclidian/cluster_3.csv')

df_cluster5 = pd.read_csv(
    './@1.DeviceLocationDataClusters_Euclidian/cluster_4.csv')
